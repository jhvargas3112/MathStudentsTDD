...
public class CalculatorValidator {
  ...
  public void validateOperatorsValueLimits(int operator1, int operator2)
      throws OperatorOutOfMinimumValueLimitException, OperatorOutOfMaximumValueLimitException {
  ...
  public void validateResultValueLimit(int result)
      throws ResultOutOfMinimumValueLimitException, ResultOutOfMaximumValueLimitException {
